...
- [ ] **P6.33** — **UI for parent-variant rollups** (KW12). Production orders list: collapsible main PA → variant children. Items list: toggle "show variants" + aggregate by BaseCode. Inventory filters: aggregate by base article across color/size. Reports at both levels per user requirement (2026-04-19).
