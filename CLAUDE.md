...
*Последна ревизија: 2026-05-14 — **Phase 17 ЗАВРШЕНА**. Сите E0–E16 испорачани и верифицирани на VPS: ClientOrder hub + Z2779 migration + AI helper drawer + 6 предефинирани alert rules + DomainEventLog + 4 нови SEQUENCE-и + audit history tab + recycle bin со block-delete + FxRate + Playwright E2E (3/3 green vs VPS in 7s). Phase 17 acceptance criteria сите check. EF migrations total: 59 (последно `P17_E16_AddFxRate`). Next: Phase 18 (Subcontractor) + Phase 19 (Speditor) во паралел, потоа Phase 20 (RLS) → Phase 21 (cutover).*